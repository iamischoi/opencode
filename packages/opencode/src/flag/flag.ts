...
export namespace Flag {
  ...
  export const OPENCODE_DISABLE_EXTERNAL_ACCESS = truthy("OPENCODE_DISABLE_EXTERNAL_ACCESS")
  export const OPENCODE_DISABLE_LSP_DOWNLOAD =
    truthy("OPENCODE_DISABLE_LSP_DOWNLOAD") || OPENCODE_DISABLE_EXTERNAL_ACCESS
  export const OPENCODE_ENABLE_EXPERIMENTAL_MODELS = truthy("OPENCODE_ENABLE_EXPERIMENTAL_MODELS")
  export const OPENCODE_DISABLE_AUTOCOMPACT = truthy("OPENCODE_DISABLE_AUTOCOMPACT")
  export const OPENCODE_DISABLE_MODELS_FETCH =
    truthy("OPENCODE_DISABLE_MODELS_FETCH") || OPENCODE_DISABLE_EXTERNAL_ACCESS
  ...
  export const OPENCODE_DISABLE_EXTERNAL_SKILLS =
    ...
    OPENCODE_DISABLE_EXTERNAL_ACCESS
